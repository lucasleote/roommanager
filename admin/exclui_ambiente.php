...
<html lang="pt-BR">
  ...
  <div class="main">
    <form method="POST" action="">
      <center><h2>Confirma exclusão do ambiente <?php echo "<i>$nome</i> do <i>$bloco</i>?"; ?></h2></center>
      <center>
      <button type="submit" name="enviar" class="btn btn-success">Sim</button>
      <a href="listar_ambientes.php"><button type="button" class="btn btn-danger">Não</button></a>
      </center>
    </form>
  </div>
